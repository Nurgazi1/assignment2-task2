public class Bus extends Vehicle {
    ...
    public String toString() {
        return "Model: " + getModel() + ". Year: " + getYear() + ". Base Price: " + getBasePrize() + ". ID: " + getId() + ". Number of doors: " + passangrCapacity + ". Has Airbags: " + bodyInjuryFee + ". Insurance Fee: " + calculateInsuranceFee();
    }
